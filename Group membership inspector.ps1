...
$group = Get-ADGroup -filter * -Properties groupcategory | Out-GridView -title "Steven's Group membership inspector -select the desired group, use the filter" -PassThru | format-wide
